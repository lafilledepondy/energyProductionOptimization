...
#  Heuristic basic
# -----------------------------
class MaintenanceHeuristic_basic(AbstractMaintenanceHeuristic):
...
# -----------------------------
#  Heuristic MultiCampaign 
# -----------------------------
class MaintenanceHeuristic_MultiCampaign(MaintenanceHeuristic_basic):
    def findFeasibleStartTime(
        self,
        data: Readingfile,
        i: int,
...
#  Heuristic OptXandY
# -----------------------------
class MaintenanceHeuristic_OptXandY(MaintenanceHeuristic_MultiCampaign):
     def solve(self, data: Readingfile, scenario: int) -> Solution:
        self.set_data_attrs(data, scenario)
        start_time = time.time()
        result = self.scheduleMaintenance(data)
...
# -----------------------------
#  Heuristic Random Forest models
# -----------------------------
class MaintenanceHeuristic_RF(MaintenanceHeuristic_basic):
    """
...
# -----------------------------
#  Heuristic relaxLagrange
# -----------------------------
class MaintenanceHeuristic_relaxLagrange(MaintenanceHeuristic_basic):

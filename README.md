...
- **[Relaxations: linear & lagrangienne](assets/relaxation_lineaire_lagrangienne.pdf)** – Relaxations report (linear and Lagrangian methods) (note: report is in English)
